...
a persistence unit "sPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "s/pom.xml":
...
artifact ("s.war") is already built. You can build
